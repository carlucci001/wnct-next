    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        {!isRegistering && (
          <div className="mb-6">
            <button
              ...
              disabled={loading}
              className="w-full bg-white border-2 border-gray-300 text-gray-700 font-semibold py-3 rounded-lg hover:bg-gray-50 transition flex items-center justify-center gap-3 disabled:opacity-50"
            >
        ...
        <div className="mt-6 text-center">
          ...
          >
            {isRegistering ? (
              <>Already have an account? <span className="text-blue-600 font-semibold hover:text-blue-700">Sign In</span></>
            ) : (
              <>Don&apos;t have an account? <span className="text-blue-600 font-semibold hover:text-blue-700">Sign Up</span></>
            )}
          </button>
        </div>
        ...
        {!isRegistering && (
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs text-gray-500 text-center mb-3">Quick Access (Demo)</p>
            <button
              type="button"
              onClick={() => {
                setIdentifier('admin@wnctimes.com');
                setPassword('admin123');
              }}
              className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-4 rounded-lg text-sm transition"
            >
              Fill Admin Credentials
            </button>
            <div className="mt-3 bg-gray-50 rounded-lg p-3 text-xs text-gray-600">
              <div><strong>Email:</strong> admin@wnctimes.com</div>
              <div><strong>Password:</strong> admin123</div>
              <p className="text-[10px] text-gray-400 mt-2">Create this account first via Sign Up if it doesn&apos;t exist</p>
            </div>
          </div>
        )}
      </div>
