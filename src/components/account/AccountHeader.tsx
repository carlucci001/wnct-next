...
import { canAccessAdmin } from '@/config/accountMenus';
...
export function AccountHeader({
  ...
  const { theme, setTheme, colorMode, toggleColorMode, availableThemes } =
    useTheme();

  return (
    <TooltipProvider>
      <header className="h-16 border-b bg-card flex items-center justify-between px-3 md:px-6 shrink-0">
        {/* Left: Mobile Menu Button, Logo & Badge */}
        ...
        <div className="flex items-center gap-0.5 md:gap-1">
          ...
          {/* Admin Panel - hidden on mobile, only for admin roles */}
