...
export const DEFAULT_MENUS: SiteMenu[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'local-news', label: 'Local News', path: '/category/news', enabled: true, order: 0 },
      { id: 'business', label: 'Business', path: '/category/business', enabled: true, order: 1 },
      { id: 'outdoors', label: 'Outdoors', path: '/category/outdoors', enabled: true, order: 2 },
      { id: 'arts', label: 'Arts & Culture', path: '/category/arts', enabled: true, order: 3 },
      { id: 'food', label: 'Food & Drink', path: '/category/food', enabled: true, order: 4 },
      { id: 'realestate', label: 'Real Estate', path: '/category/realestate', enabled: true, order: 5 },
    ],
    enabled: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
